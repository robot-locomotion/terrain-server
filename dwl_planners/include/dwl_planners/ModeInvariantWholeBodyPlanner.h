#ifndef DWL_PLANNERS__MODE_INVARIANT_WHOLE_BODY_PLANNER__H
#define DWL_PLANNERS__MODE_INVARIANT_WHOLE_BODY_PLANNER__H
...
class ModeInvariantWholeBodyPlanner
{
	public:
		/** @brief Constructor function */
		ModeInvariantWholeBodyPlanner(ros::NodeHandle node = ros::NodeHandle("~"));
